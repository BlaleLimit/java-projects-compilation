...
// Process
	public static void fcfsProcess(int[][] array, int size) {
		// initialize values
		int[] pid = array[0];
		int[] at = array[1];
		int[] bt = array[2];
	...
	public static void sjfNPProcess(int[][] array, int size) {
		// initialize values
		int[] pid = array[0];
		int[] at = array[1];
		int[] bt = array[2];
	...
	public static void sjfPProcess(int[][] array, int size) {
		// initialize values
		int[] pid = array[0];
		int[] at = array[1];
		int[] bt = array[2];
	...
	public static void prioPProcess(int[][] array, int size) {
		// initialize values
		int[] pid = array[0];
		int[] at = array[1];
		int[] bt = array[2];
...
// Misc Functions
        ...
        while (true) {
            try {
				switch (scan.next().charAt(0)) {
					case 'a', 'A' -> algorithm(size, array, 1);
					case 'b', 'B' -> algorithm(size, array, 2);
					case 'c', 'C' -> algorithm(size, array, 3);
					case 'd', 'D' -> algorithm(size, array, 4);
					case 'e', 'E' -> {
    		...
    		if (i%2 == 1) {
    			if (arr.get(i) == 0)
    				temp.append("| IS |"); // pid
      				...
      				temp.append("| P").append(arr.get(i)).append(" |"); // pid
    		}
      		else
      			temp.append(" ").append(arr.get(i)).append(" "); // time
    	}
    	System.out.println("\nGantt Chart (Simple)");
    ...
    public static void ganttChart2(ArrayList<Integer> arr) {
    	...
    	ArrayList<Integer> pidl = new ArrayList<>();
    	ArrayList<Integer> timel = new ArrayList<>();
    ...
    public static void repeat(int size, int[][] tempArray) {
        ...
        try {
			switch (choice) {
				case 'a', 'A' -> choice(size, tempArray);
				case 'b', 'B' -> main(null);
				case 'c', 'C' -> {
					System.out.println("Thank you for using our program.");
					exit(0);
